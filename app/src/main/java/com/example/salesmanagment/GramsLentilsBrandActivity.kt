...
class GramsLentilsBrandActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_grams_lentils_brand)

        brandName = intent.getStringExtra("BRAND_NAME") ?: "Grams & Lentils"

        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.grams_brand_root)) { v, insets ->
    ...
    private fun loadMockBrandData() {
        val mock = listOf(
            Product("g1", "$brandName 500g", "Grams & Lentils", 120.0, 30),
            Product("g2", "$brandName 1kg", "Grams & Lentils", 230.0, 20),
            Product("g3", "$brandName 2kg", "Grams & Lentils", 450.0, 10)
        )
