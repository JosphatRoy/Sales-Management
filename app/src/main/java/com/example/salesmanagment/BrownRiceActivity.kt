...
class BrownRiceActivity : AppCompatActivity() {

    private val brownRiceBrands = listOf(
        CategoryData("Cil Aromatic Brown Rice", "High quality aromatic brown rice.", R.drawable.ic_shopping_cart, "#D7CCC8")
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.brown_rice_root)) { v, insets ->
