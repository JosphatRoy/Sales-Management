...
class PopcornBrandActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_popcorn_brand)

        brandName = intent.getStringExtra("BRAND_NAME") ?: "Popcorn"

        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.popcorn_brand_root)) { v, insets ->
    ...
    private fun loadMockBrandData() {
        val mock = listOf(
            Product("pop1", "$brandName 500g", "Popcorns & Grains", 150.0, 40),
            Product("pop2", "$brandName 1kg", "Popcorns & Grains", 280.0, 20),
            Product("pop3", "$brandName Value Pack", "Popcorns & Grains", 500.0, 15)
        )
